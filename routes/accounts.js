...
router.get("/listAkun", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Gagal mengambil list akun.", error: error.message });
  }
});
...
router.post("/addListAkun", async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Gagal menyimpan list akun.",
        error: error.message,
      });
  }
});
...
router.delete("/deleteListAkun/:id", async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Gagal menghapus list akun.",
        error: error.message,
      });
  }
});
...
router.put("/editListAkun/:id", async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Gagal memperbarui list akun.",
        error: error.message,
      });
  }
});
